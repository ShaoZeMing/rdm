...
void RedisClient::AbstractTransporter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (AbstractTransporter::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AbstractTransporter::errorOccurred)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (AbstractTransporter::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AbstractTransporter::logEvent)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (AbstractTransporter::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AbstractTransporter::connected)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (AbstractTransporter::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AbstractTransporter::commandAdded)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (AbstractTransporter::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AbstractTransporter::queueIsEmpty)) {
                *result = 4;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject RedisClient::AbstractTransporter::staticMetaObject = {
