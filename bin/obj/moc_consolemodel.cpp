...
void Console::Model::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Model::*)(const QString & , bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Model::changePrompt)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Model::*)(const QString & , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Model::addOutput)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Console::Model::staticMetaObject = {
    { &TabModel::staticMetaObject, qt_meta_stringdata_Console__Model.data,
      qt_meta_data_Console__Model,  qt_static_metacall, nullptr, nullptr}
};
