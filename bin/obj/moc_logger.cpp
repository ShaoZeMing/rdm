...
void LogHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (LogHandler::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LogHandler::event)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject LogHandler::staticMetaObject = {
...
void *LogHandler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "el::LogDispatchCallback"))
        return static_cast< el::LogDispatchCallback*>(this);
