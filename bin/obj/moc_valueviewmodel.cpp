...
void ValueEditor::ValueViewModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ValueViewModel::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ValueViewModel::rowsLoaded)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ValueViewModel::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ValueViewModel::error)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ValueEditor::ValueViewModel::staticMetaObject = {
