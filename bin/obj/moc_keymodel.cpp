...
void ValueEditor::ModelSignals::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ModelSignals::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ModelSignals::dataLoaded)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ModelSignals::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ModelSignals::removed)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ValueEditor::ModelSignals::staticMetaObject = {
