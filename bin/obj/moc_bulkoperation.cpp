...
void BulkOperations::CurrentOperation::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (CurrentOperation::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CurrentOperation::notifyCallerAboutSuccess)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject BulkOperations::CurrentOperation::staticMetaObject = {
