...
void ConnectionsTree::ServerItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ServerItem::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ServerItem::editActionRequested)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ServerItem::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ServerItem::deleteActionRequested)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ConnectionsTree::ServerItem::staticMetaObject = {
