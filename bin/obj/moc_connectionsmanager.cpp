...
void ConnectionsManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ConnectionsManager::*)(ServerConfig );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ConnectionsManager::editConnection)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ConnectionsManager::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ConnectionsManager::connectionAboutToBeEdited)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (ConnectionsManager::*)(QSharedPointer<RedisClient::Connection> );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ConnectionsManager::openConsole)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (ConnectionsManager::*)(QSharedPointer<RedisClient::Connection> );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ConnectionsManager::openServerStats)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (ConnectionsManager::*)(QSharedPointer<RedisClient::Connection> , ConnectionsTree::KeyItem & , bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ConnectionsManager::openValueTab)) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (ConnectionsManager::*)(QSharedPointer<RedisClient::Connection> , std::function<void()> , int , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ConnectionsManager::newKeyDialog)) {
                *result = 5;
                return;
            }
        }
        {
            using _t = void (ConnectionsManager::*)(QSharedPointer<RedisClient::Connection> , int , const QRegExp & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ConnectionsManager::closeDbKeys)) {
                *result = 6;
                return;
            }
        }
        {
            using _t = void (ConnectionsManager::*)(QSharedPointer<RedisClient::Connection> , int , BulkOperations::Manager::Operation , QRegExp , std::function<void()> );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ConnectionsManager::requestBulkOperation)) {
                *result = 8;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ConnectionsManager::staticMetaObject = {
...
void *ConnectionsManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "BulkOperations::ConnectionsModel"))
        return static_cast< BulkOperations::ConnectionsModel*>(this);
