...
void RedisClient::SignalWaiter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (SignalWaiter::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SignalWaiter::succeed)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SignalWaiter::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SignalWaiter::aborted)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject RedisClient::SignalWaiter::staticMetaObject = {
...
QT_INIT_METAOBJECT const QMetaObject RedisClient::CommandExecutor::staticMetaObject = {
